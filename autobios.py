...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('autobios.log'),
...
class AutoBiosWindow(QtWidgets.QWidget):
    ...
    def __init__(self) -> None:
        ...
        # Optimized search with debouncing (150ms delay after typing stops)
        self._search_timer = QtCore.QTimer()
        self._search_timer.setSingleShot(True)
        self._search_timer.setInterval(80)  # Ultra-fast: 80ms for instant response
        ...
        # Add buttons to footer (Import and Export together)
        for b in (self.btn_import, self.btn_export, self.btn_load, self.btn_save, self.btn_apply):
            footer.addWidget(b)
    ...
    def import_scewin(self) -> None:
        ...
        # Execute non-blocking import
        logging.info(f"Starting import: {self.current_path}")
        self.scewin_runner.run_import(self.current_path, exe)
